let arr1 = [                                      // first EX of transection
...
let arr =  [ { 'paidBy': 'A', 'paidFor': { 'C': 300, 'E': 40, 'F': 30 } },   // thired EX of transection
...
function simplifyDebts() {                      
  ...
  arr.forEach(e => {         
    ...
    arrK.forEach(e => {
    index = arrK.indexOf(e);              // got index of members array to add in added values 
